...
int main() {
	...
	//cout << distance(0.437839, 0.192849, 0.875679, 0.38421) << endl;
	//cout << distance(2060.03, 1282.24, 2060.06, 1282.35) << endl;
...
//	double max_s = 6945.554;
		...
		if (length && length > 2 && data[0] == '4' && data[1] == '2') {
			...
			if (s != "") {
				...
				if (event == "telemetry") {
					...
					pathGenerator.update_ego_state(previous_path_x, previous_path_y, end_path_s, end_path_d, car_x, car_y, car_s, car_d, car_yaw, car_speed);
	...
	h.onConnection([&pathGenerator](uWS::WebSocket<uWS::SERVER> ws, uWS::HttpRequest req) {
